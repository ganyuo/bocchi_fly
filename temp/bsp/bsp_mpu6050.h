...
//端口移植
#define RCC_MPU6050 	RCC_AHB1Periph_GPIOB
...
//获取SDA引脚的电平变化
#define SDA_GET()       GPIO_ReadInputDataBit(PORT_MPU6050, GPIO_SDA)
//SDA与SCL输出
#define SDA(x)          GPIO_WriteBit(PORT_MPU6050, GPIO_SDA, (x?Bit_SET:Bit_RESET) )
#define SCL(x)          GPIO_WriteBit(PORT_MPU6050, GPIO_SCL, (x?Bit_SET:Bit_RESET) )
